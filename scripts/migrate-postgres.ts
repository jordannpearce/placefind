...
const EXPECTED_TABLES = ["users", "sessions", "orders", "issued_licenses", "mail_outbox", "campaigns", "scan_runs", "password_resets", "hosted_keys", "geo_points", "geo_imports", "search_ip", "listings", "crawls", "reviews"] as const
