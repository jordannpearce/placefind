  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "A session cookie keeps you signed in while you move between pages. Clearing cookies signs you out. Every page also loads a Google measurement tag (G-K9S9SHZMSF) so the operator can see how the directory is used. Every page also loads Google’s Preferred Sources library so visitors can add PlaceFind in Google Search. PlaceFind does not sell ads on the directory.",
        ],
      },
      {
