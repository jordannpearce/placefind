...
const FALLBACK_PRESETS: MailPreset[] = [
  {
    ...
    text: "Hi {{first}},\n\nYour PlaceFind account is ready. Buy a license from your account page to get a license key and the Windows setup.\n\nPlaceFind costs $49 for one Windows license.\n",
  },
  {
    type: "activation",
    label: "Activation / license",
    subject: "Activate your PlaceFind license",
    text: "Hi {{first}},\n\nYour PlaceFind license is ready to unlock the Windows app.\n\n1. Sign in and open your account page.\n2. Copy your license key.\n3. Download the Windows setup.\n4. Paste the key when PlaceFind asks you to unlock.\n\nIf you have not bought a license yet, you can get one from your account page.\n",
  },
  {
    type: "marketing",
    label: "Marketing",
    subject: "Find any Maps listing from a name and city",
    text: "Hi {{first}},\n\nPlaceFind looks up a Google Maps listing from a business name, city, and state — then tracks ranks on a map grid.\n\nOpen your account, download the Windows app, and run a scan when you are ready.\n",
  },
  {
    type: "info",
    label: "Info",
    subject: "A note from PlaceFind",
    text: "Hi {{first}},\n\nA quick note from the PlaceFind team. Sign in to your account for your license, download, and scans.\n\nReply to this email if you need help with your account.\n",
  },
  {
    type: "updates",
    label: "Updates",
