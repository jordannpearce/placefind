  ...
  return (
    <section className="mx-auto w-full max-w-xl rounded-2xl border border-line bg-panel p-8">
      ...
      <p className="mt-3 text-sm leading-6 text-muted">
        {user.name}, you can leave reviews and request quotes for free. PlaceFind does not charge $150 for that.
        A business listing is {LISTING_PRICE_LABEL} and uses a business account.
      </p>
