...
3. On **Edit listing**, add business details and write the public article, H1–H6 headings, custom HTML, page title, meta description, header tags, and schema. **Crawl Website** lists pages from the shop site (up to 80 unique same-host URLs). It does not write the article or replace details you already entered.
